...
//$hasil2= cekKamus($filteredarray);
echo $hasil2;
//$st->doStemming($filteredarray)
	 //  echo " ".$hasil.'<br>';
//$koneksi = mysqli_connect("localhost","root","","dbstbi");
 $query = "INSERT INTO dokumen (nama_file, token, tokenstem, tokenstem2)
            VALUES('$nama_file', TRIM(Replace(Replace(Replace('$filteredarray','\t',''),'\n',''),'\r','')), TRIM(Replace(Replace(Replace('$hasil','\t',''),'\n',''),'\r','')), TRIM(Replace(Replace(Replace('$hasil2','\t',''),'\n',''),'\r','')))";
         echo ">>".$query;   
...
$folder = "C://xampp/htdocs/wisuda2019/files/$nama_file";
...
$nama_file="C://xampp/htdocs/wisuda2019/files/".$nama_file;
